    ...
    <div class="card-body">
      <div class="row">
          ...
          <div class="row">
            ...
            <div v-if="cartItems.length < 1" class="row justify-content-center">
              <div class="col-sm-10">
                ...
                <p class="text-center m-0">Empty Cart</p>
              </div>
            </div>
            ...
            <div class="col-sm-4" v-for="item in cartItems" :key="item.id">
              <div class="card mb-3 rounded-0">
                ...
                <div class="card-body">
                  ...
                  <button
                    v-on:click="removeFromCart(item.id, item.spaces)"
                    class="btn btn-sm btn-warning rounded-0 w-100"
                  >
        ...
        <div class="col-sm-5">
          ...
          <input
            type="text"
            v-model="order_details.mobile"
            class="form-control rounded-0 mb-2"
            placeholder="Phone number"
            aria-label="Last name"
          />
          <button
            v-bind:disabled="validateFields()"
            v-on:click="checkOut"
